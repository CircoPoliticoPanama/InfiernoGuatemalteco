...
const MainMenu = () => {
    return (
        <div className='bg-gradient-to-t from-amber-950 to-primary to-50% w-svw h-svh overflow-hidden p-5 md:pt-[12svh]'>
            ...
            <div className='relative md:mb-10 h-[50svh] max-w-lg mx-auto'>
            ...
            <div className='flex flex-col gap-5'>
                <h1 className='text-red-800 relative z-50 w-[calc(100%-2rem)] md:w-1/2 font-black font-cinzel tracking-wide md:text-6xl mx-auto text-4xl text-center'>Bienvenido al Infierno Guatemalteco</h1>
                <Link to="/libro" className='hover:text-yellow-500 transition text-yellow-700 relative z-50 w-[calc(100%-2rem)] md:w-1/2 font-black font-cinzel tracking-wide md:text-5xl mx-auto text-2xl text-center'>Comenzar</Link>
            </div>
        </div>
    )
}
